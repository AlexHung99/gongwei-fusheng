-- 宮闈浮生 NPC 初始內容 v1.2
-- Prerequisite: schema_v1.2.sql, seed_rules_v1.2.sql and an active super_admin.
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION
            'seed_npcs_v1.2 requires an active super_admin; complete the AdminCli bootstrap first'
            USING ERRCODE = 'P0001';
    END IF;
END;
$$;
...
SELECT
    ...
    'publish',
    'v1.2 initial NPC content import',
    a.id
FROM game.npcs n
