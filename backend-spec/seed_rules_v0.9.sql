-- 宮闈浮生規則種子資料 v0.9
-- Prerequisite: schema_v0.9.sql
-- Source details and confirmed 400 annual stipend correction: rank_catalog_v0.9.md
...
SELECT
    ...
    jsonb_build_object('source', 'rank_catalog_v0.9') AS promotion_rules
