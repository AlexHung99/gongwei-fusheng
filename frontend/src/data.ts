...
export const npcs: NpcProfile[] = [
  { id: "yuzhao-emperor", name: "蕭漌辞", title: "渝昭帝", courtesy: "靖潯", image: "./assets/npc/yuzhao-emperor.jpg", personality: "溫潤如玉、心思深沉", skilled: "謀略、詩詞", unskilled: "書法", likes: "溫順謙和", dislikes: "束縛", history: "二皇子 → 渝昭帝", summary: "先帝崩逝後以謀略平定朝局、登基為帝；外示仁和，內心深沉，對錦歸情意尤深。" },
  { id: "chengzhao-empress-dowager", name: "梁怜卿", title: "珹昭皇太后", courtesy: "知微", image: "./assets/npc/chengzhao-empress-dowager.jpg", personality: "位高權重、心機深沉", skilled: "擅權、偽裝", unskilled: "詩書", likes: "財權、丹青", dislikes: "目無尊卑者", history: "太子妃 → 皇后 → 皇太后", summary: "曾與帝王恩愛甚篤，痛失皇嗣後轉而追求權勢，以縝密謀略掌握後宮。" },
  { id: "jinhui-taifei", name: "君疏鳶", title: "瑾惠太妃", courtesy: "映嫿", image: "./assets/npc/jinhui-taifei.jpg", personality: "溫柔婉約、不問世事", skilled: "琴藝、詩書", unskilled: "騎射、冷嘲熱諷", likes: "蒔花", dislikes: "踰矩", history: "琦貴嬪 → 琦妃 → 君昭容 → 儀御妃 → 瑾惠太妃", summary: "早年因盛寵而驕，歷經貶位與禁足後性情漸斂，晚年將心思寄於琴棋書畫。" },
  { id: "jia-fei", name: "虞綰今", title: "嘉妃", courtesy: "歸意", image: "./assets/npc/jia-fei.jpg", personality: "進退有度、平易近人", skilled: "琵琶、舞藝", unskilled: "書法、笛", likes: "荷花、音律", dislikes: "虛情假意", history: "側福晉 → 嘉妃", summary: "家世顯赫且行止端方，曾深受太子寵愛；錦歸入宮後逐漸失寵，表面淡然，野心仍未泯滅。", stats: { constitution: 810, strategy: 481, fortune: 584, appearance: 463 } },
  { id: "yi-fei", name: "南司韞", title: "禕妃", courtesy: "袼姝", image: "./assets/npc/yi-fei.jpg", personality: "清冷孤傲、高貴自信", skilled: "撫琴", unskilled: "飲酒", likes: "吟詩、遊玩", dislikes: "無理取鬧者、甜食", history: "側福晉 → 禕妃", summary: "出身百年簪纓世族，禮儀無懈可擊；因昔日婚事與馥錦決裂，入宮後孤高自持。", stats: { constitution: 399, strategy: 756, fortune: 621, appearance: 560 } },
  { id: "jinsheng-deyu", name: "唐錦歸", title: "錦笙德妤", courtesy: "嶠兮", image: "./assets/npc/jinsheng-deyu.jpg", personality: "嬌矜嫵媚、城府深沉", skilled: "調香、釀酒", unskilled: "鑑玉", likes: "書法、冰嬉", dislikes: "烹飪", history: "格格 → 錦笙御貴嬪 → 錦笙德妤", summary: "出身寒微而姿容出眾，深得渝昭帝寵愛；在宮中積極鞏固母家與自身地位。", stats: { constitution: 380, strategy: 700, fortune: 300, appearance: 850 } },
  { id: "li-liangren", name: "黎栖璇", title: "黎良人", courtesy: "碧禾", image: "./assets/npc/li-liangren.jpg", personality: "清醒通透、機敏聰慧", skilled: "畫技、女紅", unskilled: "馬術", likes: "知恩圖報", dislikes: "卑鄙小人", history: "侍妾 → 穎淑容 → 黎良人", summary: "入東宮後始終隱忍自守；母家叛亂使其遭貶與禁足，此後在失勢與孤寂中求存。", stats: { constitution: 599, strategy: 564, fortune: 721, appearance: 700 } },
];
