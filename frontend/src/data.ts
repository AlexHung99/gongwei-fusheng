...
export const mapPlaces: MapPlace[] = [
  ...
  { id: "taiyi", name: "太醫院", category: "數值提升", note: "請平安脈", description: "前往太醫院請平安脈，可依結果獲得不定量體質。", action: "請平安脈", limit: "每日一次", access: "all", image: "./assets/map-v2/place-taiyi-v2.webp", x: 18, y: 66, status: "今日尚未問診" },
  ...
  { id: "main-story", name: "主線劇情", category: "宮中各地", note: "管理員發布主線", description: "主線由管理人員建立與發布；玩家依事件邀請、身份及開放條件參與。", action: "查看主線事件", limit: "依各章截止時間", access: "invited", image: "./assets/map-v2/place-main-story-v2.webp", x: 50, y: 87, status: "新章開放" },
];
